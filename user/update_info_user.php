        ...
        <form  id="formulaire_inscription" class="formulaire_connexion" action="" method="post" enctype="multipart/form-data">
            <?php if ($_SESSION['sexe'] == "homme") { ?>
                <div style="margin: 0 auto" class="">
                    ...
                    <input checked style="margin-right: 3rem; margin-bottom: 2rem" type="radio" name="sexe" id="homme" value="homme">
           ...
           <?php } else { ?>
            ...
            <div class="form_input">
                ...
                <input autofocus type="text" name="nom" id="nom" value="<?php if (empty($_POST['nom'])){ echo $_SESSION['nom'];} else {echo $_POST['nom'];} ?>">
            ...
            <div class="form_input">
                ...
                <input type="text" name="prenom" id="prenom" value="<?php if (empty($_POST['prenom'])){ echo $_SESSION['prenom'];} else {echo $_POST['prenom'];} ?>">
            ...
            <div class="form_input">
                ...
                <input type="date" name="date_de_naissance" id="date_de_naissance" value="<?php if (empty($_POST['date_de_naissance'])){ echo $_SESSION['date_de_naissance'];} else {echo $_POST['date_de_naissance'];} ?>">
            ...
            <div class="form_input">
                ...
                <input type="text" name="email" id="email" value="<?php if (empty($_POST['email'])){ echo $_SESSION['email'];} else {echo $_POST['email'];} ?>">
