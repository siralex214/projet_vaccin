...
<div class="wrap_update">
    <form action="#" method="post" id="formulaire_general">
        <div class="range">
            ...
            <input step="any" name="nom" id="nom" value=" <?php if (!empty($users['nom'])) {
                echo $users['nom'];
            } ?>">
            ...
            <input type="text" name="prenom" id="prenom" value=" <?php if (!empty($users['prenom'])) {
                echo $users['prenom'];
            } ?>">
            ...
            <input type="date" name="date_de_naissance" id="date_de_naissance"
                   value="<?php if (!empty($users['date_de_naissance'])) {
                       echo $users['date_de_naissance'];
                   } ?>">
            ...
            <input type="text" name="email" id="email" value="<?php if (!empty($users['email'])) {
                echo $users['email'];
            } ?>">
